...
export default function PersonalityAssessmentSystem() {
  ...
  const analyzePersonality = (responses: number[]): PersonalityResult => {
    ...
    const personalityTypes = {
      ...
      conscientiousness: {
        primaryType: 'Analyzer/Perfectionist',
        description: 'Detail-oriented professional who ensures quality, accuracy, and systematic approaches to work.',
        strengths: ['Exceptional attention to detail', 'Systematic and organized approach', 'High quality standards', 'Analytical and logical thinking', 'Thorough research and preparation'],
        challenges: ['May get bogged down in details', 'Can be overly critical of self and others', 'May resist change or new methods', 'Tendency toward perfectionism causing delays'],
        workStyle: 'Methodical, precise, and quality-focused. Prefers structured environments with clear procedures.',
        communicationStyle: 'Detailed, factual, and well-prepared. Appreciates documentation and thorough analysis.',
        idealEnvironment: 'Structured, organized environments with clear procedures and quality standards.',
        leadershipStyle: 'Technical expert who leads through knowledge, systematic planning, and quality focus.',
        teamRole: 'Quality keeper who ensures accuracy, maintains standards, and provides thorough analysis.',
        motivators: ['Quality recognition', 'Technical challenges', 'Clear procedures', 'Expertise development', 'Accuracy appreciation'],
        stressors: ['Rushed deadlines', 'Unclear expectations', 'Disorganization', 'Frequent interruptions', 'Ambiguous goals'],
        careerSuggestions: ['Quality assurance', 'Research and development', 'Finance and accounting', 'Engineering', 'Compliance'],
        developmentAreas: ['Flexibility and adaptability', 'Time management', 'Big picture thinking', 'Risk tolerance'],
        managementTips: ['Provide clear specifications', 'Allow time for thorough work', 'Recognize quality contributions', 'Minimize interruptions']
      },
      empathy: {
        primaryType: 'Helper/Counselor',
        description: 'Compassionate individual who focuses on understanding and supporting others\' emotional and developmental needs.',
        strengths: ['Deep empathy and emotional intelligence', 'Excellent interpersonal skills', 'Natural counseling and mentoring abilities', 'Creates inclusive, supportive environments', 'Strong ethical foundation'],
        challenges: ['May take on others\' emotional burdens', 'Can struggle with difficult personnel decisions', 'May avoid necessary confrontations', 'Tendency to prioritize others over self-care'],
        workStyle: 'People-centered, supportive, and relationship-focused. Values meaningful connections and helping others grow.',
        communicationStyle: 'Warm, empathetic, and encouraging. Focuses on understanding and supporting others.',
        idealEnvironment: 'Caring, people-focused environments where helping others and making a difference is valued.',
        leadershipStyle: 'Servant leadership focused on developing others and creating supportive, inclusive environments.',
        teamRole: 'Team nurturer who supports individual development, facilitates relationships, and maintains team morale.',
        motivators: ['Helping others succeed', 'Meaningful work', 'Personal connections', 'Recognition for caring', 'Values alignment'],
        stressors: ['Conflict situations', 'Harsh criticism', 'Impersonal environments', 'Ethical conflicts', 'Others\' suffering'],
        careerSuggestions: ['Counseling and therapy', 'Social work', 'Teaching', 'Healthcare', 'Non-profit leadership'],
        developmentAreas: ['Boundary setting', 'Assertiveness', 'Business acumen', 'Objective decision-making'],
        managementTips: ['Recognize contributions to team welfare', 'Provide opportunities to help others', 'Support work-life balance', 'Align work with values']
      },
      adaptability: {
        primaryType: 'Adapter/Explorer',
        description: 'Flexible innovator who thrives on change, variety, and new experiences while maintaining optimism.',
        strengths: ['Highly adaptable to change', 'Creative problem-solving abilities', 'Optimistic and resilient outlook', 'Comfortable with ambiguity', 'Brings fresh perspectives and ideas'],
        challenges: ['May struggle with routine or repetitive work', 'Can be inconsistent in follow-through', 'May resist detailed planning or structure', 'Tendency to start many projects without finishing'],
        workStyle: 'Flexible, creative, and change-oriented. Thrives on variety and new challenges.',
        communicationStyle: 'Spontaneous, creative, and open-minded. Enjoys brainstorming and exploring possibilities.',
        idealEnvironment: 'Dynamic, changing environments with variety, creativity, and minimal rigid structure.',
        leadershipStyle: 'Visionary and innovative, focuses on exploring new possibilities and adapting to change.',
        teamRole: 'Change agent who brings new ideas, adapts to challenges, and helps team navigate transitions.',
        motivators: ['Variety and change', 'Creative challenges', 'Learning opportunities', 'Flexibility', 'Innovation recognition'],
        stressors: ['Rigid routines', 'Micromanagement', 'Repetitive tasks', 'Excessive structure', 'Lengthy detailed planning'],
        careerSuggestions: ['Consulting', 'Marketing and advertising', 'Innovation management', 'Project coordination', 'Training'],
        developmentAreas: ['Follow-through skills', 'Attention to detail', 'Time management', 'Structured planning'],
        managementTips: ['Provide variety in assignments', 'Allow flexible work arrangements', 'Support creative initiatives', 'Minimize rigid procedures']
      }
    };
